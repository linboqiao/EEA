 ...
 * @author Barbara Plank (imported Stanford tokenizer to limo)
 */
public class PTBTokenizer<T extends HasWord> extends AbstractTokenizer<T> {
  ...
  public static void tok(List<String> inputFileList, List<String> outputFileList, String charset, Pattern parseInsideBegin, Pattern parseInsideEnd, String options, boolean preserveLines, boolean dump, boolean lowerCase) throws IOException {
    Timing t = new Timing();
    int numTokens = 0;
    int sz = inputFileList.size();
    if (sz == 0) {
      ...
      while ((line = stdin.readLine()) != null) {
        ...
        System.out.println("****"+preserveLines);
      }
