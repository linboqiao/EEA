...
import limo.exrel.checks.FileCanReadCheck;


public class ExternalFileSlot extends FileSlot {
	
	public ExternalFileSlot(boolean mandatory) {
		super(mandatory);
	}
	
	@Override
	protected void addDefaultChecks() {
		addCheck(new FileCanReadCheck());
	}
