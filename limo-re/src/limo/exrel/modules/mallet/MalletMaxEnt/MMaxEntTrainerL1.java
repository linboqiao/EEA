...
public class MMaxEntTrainerL1 extends ClassifierTrainer<MaxEnt>
implements ClassifierTrainer.ByOptimization<MaxEnt>, Boostable, Serializable {

	private static Logger logger = MalletLogger.getLogger(MMaxEntTrainerL1.class.getName());
	private static Logger progressLogger = MalletProgressMessageLogger.getLogger(MMaxEntTrainerL1.class.getName()+"-pl");
	...
	public MMaxEntTrainerL1 () {}
	
	public MMaxEntTrainerL1 (RegularizationWeightProducer regularizer) {
	 ...
	 *   initial values.
	 */ 
	public MMaxEntTrainerL1 (MaxEnt theClassifierToTrain) {
		this.initialClassifier = theClassifierToTrain;
	}
	
	public MMaxEntTrainerL1 (MaxEnt theClassifierToTrain, RegularizationWeightProducer regularizer) {
		this.initialClassifier = theClassifierToTrain;
		this.regularizer = regularizer;
	}
...
//				}
	...
	public Optimizer getOptimizer (InstanceList trainingSet) {
		...
		if (optimizer == null) {
			...
			//  may be faster.
			optimizer = new FlexibleOrthantWiseLimitedMemoryBFGS(optimizable, regularizer, numFeatures, numLabels); 
	...
	public MMaxEntTrainerL1 setNumIterations (int i) {
		numIterations = i;
		return this;
	}
