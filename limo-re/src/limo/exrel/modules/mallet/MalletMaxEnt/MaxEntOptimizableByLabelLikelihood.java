...
public class MaxEntOptimizableByLabelLikelihood implements Optimizable.ByGradientValue {
	...
	public static final double DEFAULT_GAUSSIAN_PRIOR_VARIANCE = 1;
	public static final double DEFAULT_HYPERBOLIC_PRIOR_SLOPE = 0.2;
	public static final double DEFAULT_HYPERBOLIC_PRIOR_SHARPNESS = 10.0;
	public static final Class DEFAULT_MAXIMIZER_CLASS = LimitedMemoryBFGS.class;

	public boolean usingHyperbolicPrior = false;
	public boolean usingGaussianPrior = true;
	double gaussianPriorVariance = DEFAULT_GAUSSIAN_PRIOR_VARIANCE;
	public double hyperbolicPriorSlope = DEFAULT_HYPERBOLIC_PRIOR_SLOPE;
	public double hyperbolicPriorSharpness = DEFAULT_HYPERBOLIC_PRIOR_SHARPNESS;
	public Class maximizerClass = DEFAULT_MAXIMIZER_CLASS;

	public double[] parameters, constraints, cachedGradient;
	public MaxEnt theClassifier;
	public InstanceList trainingList;
	// The expectations are (temporarily) stored in the cachedGradient
	public double cachedValue;
	public boolean cachedValueStale;
	public boolean cachedGradientStale;
	public int numLabels;
	public int numFeatures;
	public int defaultFeatureIndex;						// just for clarity
	public FeatureSelection featureSelection;
	public FeatureSelection[] perLabelFeatureSelection;
	public int numGetValueCalls = 0;
	public int numGetValueGradientCalls = 0;
