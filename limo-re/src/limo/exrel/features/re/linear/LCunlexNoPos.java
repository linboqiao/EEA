...
// local context
public class LCunlexNoPos extends RelationExtractionLinearFeature {
/*
	Token. The token itself.
	Lemma. The lemma of the token.  no!
	PoS. The PoS tag of the token.  no!
	Stem. The stem of the token.  no!
