...
//This class is modified from cc.mallet.classify.MaxEntTrainer
public class MMaxEntTrainerL2 extends ClassifierTrainer<MaxEnt>
		implements ClassifierTrainer.ByOptimization<MaxEnt>, Boostable, Serializable {
	
	private static Logger logger = MalletLogger.getLogger(MMaxEntTrainerL2.class.getName());
	private static Logger progressLogger = MalletProgressMessageLogger.getLogger(MMaxEntTrainerL2.class.getName()+"-pl");
	...
	MMEOptimizableByLabelLikelihoodL2 optimizable = null; //MaxEntOptimizableByLabelLikelihood
	...
	public MMaxEntTrainerL2 () {}
	
	public MMaxEntTrainerL2 (RegularizationWeightProducer regularizer) {
	 ...
	 *   initial values.
	 */ 
	public MMaxEntTrainerL2 (MaxEnt theClassifierToTrain) {
		this.initialClassifier = theClassifierToTrain;
	}
	
	public MMaxEntTrainerL2 (MaxEnt theClassifierToTrain, RegularizationWeightProducer regularizer) {
		this.initialClassifier = theClassifierToTrain;
		this.regularizer = regularizer;
	}
	 ...
	 * the default value. */
//	public MMaxEntTrainerL2 (double gaussianPriorVariance) {
//		this.gaussianPriorVariance = gaussianPriorVariance;
//	}
//	
//	public MMaxEntTrainerL2 (double gaussianPriorVariance, RegularizationWeightProducer regularizer) {
//		this.gaussianPriorVariance = gaussianPriorVariance;
//		this.regularizer = regularizer;
//	}
	...
	public MMEOptimizableByLabelLikelihoodL2 getOptimizable (InstanceList trainingSet) {
		return getOptimizable(trainingSet, getClassifier());
	}

	public MMEOptimizableByLabelLikelihoodL2 getOptimizable (InstanceList trainingSet, MaxEnt initialClassifier) {
		...
		if (trainingSet != this.trainingSet || this.initialClassifier != initialClassifier) {
			...
			if (optimizable == null || optimizable.trainingList != trainingSet) {
				optimizable = new MMEOptimizableByLabelLikelihoodL2 (trainingSet, initialClassifier, regularizer);
...
//				}
	...
	public MMaxEntTrainerL2 setNumIterations (int i) {
		numIterations = i;
		return this;
	}
...
//			return optimizer.getIteration ();
	 ...
	 * @return This trainer
	 */
//	public MMaxEntTrainerL2 setGaussianPriorVariance (double gaussianPriorVariance) {
//		this.gaussianPriorVariance = gaussianPriorVariance;
//		return this;
//	}
	 ...
	 */
//	public MMaxEntTrainerL2 setL1Weight(double l1Weight) {
...
//	}
	...
	public MaxEnt train (InstanceList trainingSet, int numIterations)
	{
		...
		for (int i = 0; i < numIterations; i++) {
			try {
				System.out.print("Iteration " + i + ": "); //Thien added this
...
*/
	...
	public String toString() {
		...
		builder.append("MMaxEntTrainerL2");
		if (numIterations < Integer.MAX_VALUE) {
