...
import limo.exrel.checks.DirCanExecuteCheck;
import limo.exrel.checks.DirCanReadCheck;


public class InputDirSlot extends FileSlot {
	
	public InputDirSlot(boolean mandatory) {
		super(mandatory);
	}

	@Override
	protected void addDefaultChecks() {
		addCheck(new DirCanReadCheck());
		addCheck(new DirCanExecuteCheck());
	}
