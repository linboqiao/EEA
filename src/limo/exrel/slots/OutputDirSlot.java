...
import limo.exrel.checks.DirCanWriteCheck;


public class OutputDirSlot extends FileSlot {

	public OutputDirSlot(boolean mandatory) {
		super(mandatory);
	}
	
	@Override
	protected void addDefaultChecks() {
		addCheck(new DirCanWriteCheck());		
	}
