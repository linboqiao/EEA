<<<<<<< HEAD:cmu-script/cmu-script/event-coref/src/main/java/edu/cmu/cs/lti/event_coref/annotators/JointMentionCorefAnnotator.java
...
public class JointMentionCorefAnnotator extends AbstractConfigAnnotator {
    ...
    public void initialize(UimaContext aContext) throws ResourceInitializationException {
        ...
        decoder = new BeamCrfLatentTreeDecoder(crfWeights, realisModel, corefWeights, realisExtractor,
                mentionExtractor, beamSize);
    }
...
>>>>>>> 0b1d50b9fb7eda2a0594d07b1bb39c417e65ceee:cmu-script/event-coref/src/main/java/edu/cmu/cs/lti/event_coref/annotators/JointMentionCorefAnnotator.java
