 ...
 */
public class FanseAnnotatorPipeline {

    private static String className = FanseAnnotatorPipeline.class.getSimpleName();
    ...
    public static void main(String[] args) throws UIMAException {
        ...
        AnalysisEngineDescription analyzer = AnalysisEngineFactory.createEngineDescription(
                ...
                FanseAnnotator.PARAM_MODEL_BASE_DIR, paramModelBaseDirectory);
