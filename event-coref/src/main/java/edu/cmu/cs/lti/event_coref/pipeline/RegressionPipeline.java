...
public class RegressionPipeline {
    ...
    public RegressionPipeline(String typeSystemName, String goldStandardFilePath, String plainTextDataDir,
    ...
    public CollectionReaderDescription goldMentionDetection(CollectionReaderDescription reader, String baseOutput)
        ...
        BasicPipeline pipeline = new BasicPipeline(new AbstractProcessorBuilder() {
            ...
            public AnalysisEngineDescription[] buildProcessors() throws ResourceInitializationException {
                ...
                AnalysisEngineDescription xmiWriter = CustomAnalysisEngineFactory.createXmiWriter(workingDir,
                        baseOutput);
                return new AnalysisEngineDescription[]{goldMentionTypeAnnotator, acceptor, xmiWriter};
            }
        }, typeSystemDescription);
...
//                );
                ...
                AnalysisEngineDescription xmiWriter = CustomAnalysisEngineFactory.createXmiWriter(workingDir,
                        outputBase);
                return new AnalysisEngineDescription[]{corefAnnotator,
                        xmiWriter};
            }
        }, typeSystemDescription);
...
//            CollectionReaderDescription goldMentionRealisResults = realisAnnotation(taskConfig,
// goldMentionOutputReader,
...
//                    realisModelDir, lv1RealisOutput);
            ...
            String corefOutput = edu.cmu.cs.lti.utils.FileUtils.joinPaths(middleResults, sliceSuffix,
                    "tree_coref");
            CollectionReaderDescription corefResults = corefResolution(devSliceReader, taskConfig,
                    treeCorefModel, corefOutput);
...
//                    new File(goldMentionEval, "gold_mention_realis" + sliceSuffix + ".tbf").getPath(), "gold_types");
            ...
            writeResults(corefResults,
                    new File(corefEval, "tree_coref" + sliceSuffix + ".tbf").getPath(), "tree_coref");
    ...
    public static void main(String argv[]) throws Exception {
        ...
        // Give a directory for regression test.
        ...
        RegressionPipeline pipeline = new RegressionPipeline(typeSystemName, goldTbf, sourceDir,
