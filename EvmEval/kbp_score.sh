...
$scorer -g $gold_dir/gold_nugget -s /home/linbo/workspace/Xing/TA/cmu-script/sample-output/eval/full_run/lv1_coref.tbf -t $gold_dir/tkn/ -d ./output/A_out.tmp -o ./output/score_cmu-script.txt
