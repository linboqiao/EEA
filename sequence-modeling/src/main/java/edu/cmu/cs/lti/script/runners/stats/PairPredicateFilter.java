...
import edu.cmu.cs.lti.script.annotators.stats.FastEventMentionHeadCounter;
    ...
    public static void main(String args[]) throws Exception {
        ...
        try {
            SerializationHelper.write(
                    new File(dbPath, FastEventMentionHeadCounter.defaultDBName +
                            "_" + FastEventMentionHeadCounter.defaultMentionPairCountName
