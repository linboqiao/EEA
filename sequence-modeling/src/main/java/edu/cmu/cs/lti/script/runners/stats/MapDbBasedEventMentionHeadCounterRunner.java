...
import edu.cmu.cs.lti.script.annotators.stats.MapDbBasedEventMentionHeadCounter;
 ...
 * Time: 5:30 PM
 */
public class MapDbBasedEventMentionHeadCounterRunner {
    private static String className = MapDbBasedEventMentionHeadCounterRunner.class.getSimpleName();
