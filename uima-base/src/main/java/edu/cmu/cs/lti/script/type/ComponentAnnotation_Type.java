...
public class ComponentAnnotation_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.cs.lti.script.type.ComponentAnnotation");
  ...
  public String getComponentId(int addr) {
      ...
      jcas.throwFeatMissing("componentId", "edu.cmu.cs.lti.script.type.ComponentAnnotation");
  ...
  public String getId(int addr) {
      ...
      jcas.throwFeatMissing("id", "edu.cmu.cs.lti.script.type.ComponentAnnotation");
