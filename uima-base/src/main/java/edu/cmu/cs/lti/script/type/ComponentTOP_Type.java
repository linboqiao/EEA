...
public class ComponentTOP_Type extends TOP_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.cs.lti.script.type.ComponentTOP");
  ...
  public String getComponentId(int addr) {
      ...
      jcas.throwFeatMissing("componentId", "edu.cmu.cs.lti.script.type.ComponentTOP");
  ...
  public String getId(int addr) {
      ...
      jcas.throwFeatMissing("id", "edu.cmu.cs.lti.script.type.ComponentTOP");
